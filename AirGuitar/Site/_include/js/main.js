...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '_include/img/slider-images/hiring-video-banner.jpg', title : '<div class="slide-content"><h1 class="splash-page-header"><strong>Welcome to <span class="color-text">AirGuitar</span></strong></h1><p><a class="splash-page-link" href="https://www.youtube.com/watch?v=i5fVHytUfTo">We are hiring. Click here to check us out!</a></p></div>', thumb : '', url : ''}
									],
